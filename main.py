...
pdfs = ('https://www.cpf.gov.sg/content/dam/web/member/healthcare/documents/InformationBookletForTheNewlyInsured.pdf', 'https://www.moh.gov.sg/docs/librariesprovider5/medisave/table-of-surgical-procedures-(as-of-1-jan-2024).pdf')
pdf_search_tool = PDFSearchTool(pdf=pdfs)
