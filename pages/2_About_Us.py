...
st.markdown('''**Use Cases for Navigating Healthcare Coverage and Protection (MediShield Life and Medisave):**
        ...
        This use case will allow users to simulate various hospital ward class scenarios based on information, such as benefits, government subsidies, deductible, co-insurance and exclusions under the MediShield Life Scheme. Users can use this information to plan the hospital ward class that suits their budget and helping them make informed decision if additional private insurance coverage is required.\n
