...
st.write("Use Cases for Navigating Healthcare Coverage and Protection (MediShield Life and Medisave):
        ...
        Users can use this information to plan the hospital ward class that suits their budget and helping them make informed
        decision if additional private insurance coverage is required.
